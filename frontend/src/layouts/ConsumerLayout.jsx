...
const navItems = [
  { label: 'Dashboard', path: '/consumer/dashboard', icon: <DashboardRoundedIcon /> },
  { label: 'My Profile', path: '/consumer/profile', icon: <PersonRoundedIcon /> },
  { label: 'Search Services', path: '/consumer/search', icon: <SearchRoundedIcon /> },
  { label: 'My Bookings', path: '/consumer/bookings', icon: <BookmarkRoundedIcon /> },
];
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <List sx={{ px: 1.5, pb: 2 }}>
        <ListItem disablePadding>
          <ListItemButton onClick={handleLogout} sx={{ borderRadius: 2, color: 'error.main', '&:hover': { bgcolor: 'error.lighter' } }}>
